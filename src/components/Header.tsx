        ...
        <>
            <div className='mt-10 md:mb-10 lg:mb-20 relative'>
                <div className='flex flex-row gap-5'>
                    <img src={Logo} alt="logo" className='aspect-square w-auto max-w-[30px] md:max-w-[60px] h-auto dark:invert opacity-80 cursor-pointer' onClick={() => (window.location.href = "/")}></img>
